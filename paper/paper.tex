...
The \CRLB\ is related to the Fisher Information that is frequently
used in cosmological experiment forecasts.
...
In the case of \EPRV, this says that it is impossible to compute the
CRLB without making assumptions about the stellar spectrum (the
...
These noise processes necessarily must include any beliefs about
...
\acknowledgements
MPIA hospitality, Montet, Foreman-Mackey, Bean, Sturmer, Rix, HARPS team, ESO, Stars group meeting, Brewer
