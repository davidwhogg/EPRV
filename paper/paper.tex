...
saturate the information-theoretic bound on precision---the
Cram\'er--Rao bound (\CRLB)---given an extracted spectrum (and
...
method, provided that there is sufficient barycentric velocity variation.
\end{abstract}
