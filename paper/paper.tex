...
...insert here one paragraph for each major result from the
abstract. Each paragraph should emphasize the awesome of the result,
but then discuss limitations or interpretation...
...
of the \HARPS\ team and \ESO, who built the instrument and made the
