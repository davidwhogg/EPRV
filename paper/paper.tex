...
We draw out the relationships and equivalencies across these methods.
...
enough to saturate the \CRLB, provided that there are multiple epochs
of observations and the star does not vary substantially between
epochs.
...
by the quality of the spectral models of the targets of the
spectroscopy.
...
the data-analysis methodologies in use are contributing to this
empirical variance?
This is a question in information theory and inference.

\todo{syntactical reference}
