...
estimator (that is, the information in the velocity) must be smaller than the
...
and the expectation $E[]$ is taken over all possible data (that is, it is an
...
\begin{itemize}
\item what is the Cramer-Rao bound on a spectrum in optimistic case? 
