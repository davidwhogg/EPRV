...
%wavelength calibration assumption removed b/c it fits better in Section 2... but maybe we want to add it back?
...
\begin{equation}
-\frac{1}{2}\,[y - f]\T\cdot C^{-1}\cdot [y - f] = -\frac{1}{2}\,y\T\cdot C^{-1}\cdot y + y^T\cdot C^{-1}\cdot f 
...
...For the cross-correlation template $f$ you could use...
\begin{itemize}
